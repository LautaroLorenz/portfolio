			...
			function ue(e, t) {
				...
				if (S) {
					...
					le(
						...
						void 0 !== e.SVGElement &&
							le(e.SVGElement.prototype, ie, o),
			...
			Zone.__load_patch('legacy', (e) => {
				...
				Zone.__load_patch('PromiseRejectionEvent', (e, t) => {
					...
					e.PromiseRejectionEvent &&
						((t[k('unhandledPromiseRejectionHandler')] = n(
							'unhandledrejection'
						)),
						(t[k('rejectionHandledHandler')] = n(
							'rejectionhandled'
						)));
				});
		}
